...
void InitEqepGPIO(void)
{
    ...
    GPIO_setPinConfig(GPIO_20_EQEP1A);                // GPIO24 = EQEP2A
    GPIO_setPinConfig(GPIO_21_EQEP1B);                // GPIO25 = EQEP2B
    GPIO_setPinConfig(GPIO_23_EQEP1I);                // GPIO26 = EQEP2I
